...
def parse_rec(filename):
    """ Parse a pascal annotation file """
...
def custom_dataset_ap(rec, prec, use_07_metric=False):
    """ ap = custom_dataset_ap(rec, prec, [use_07_metric])
    Compute atekemera  AP given precision and recall.
    If use_07_metric is true, uses the
    voc07 11 point method (default:False).
    """
    if use_07_metric:
        # 11 point metric
        ap = 0.
